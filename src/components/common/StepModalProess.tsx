    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[26px] border border-white/25 bg-white/70 backdrop-blur-2xl shadow-2xl">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="w-14 h-14 rounded-2xl bg-white/80 border border-[#0056d2]/25 flex items-center justify-center shadow-sm">
                  ...
                  <div className="text-right">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/70 border border-white/30 text-xs text-gray-700">
                ...
                <button
                  onClick={onClose}
                  className="w-11 h-11 rounded-2xl bg-white/75 border border-white/30 flex items-center justify-center hover:scale-[1.03] active:scale-[0.98] transition cursor-pointer"
                  aria-label="إغلاق"
                >
                  <Icon
            ...
            <div className="relative px-6 pb-6">
              <div className="rounded-2xl border border-white/25 bg-white/55 p-5 md:p-6">
                <p className="text-sm md:text-base leading-8 text-gray-800">
                  {step.description}
                </p>
              </div>
              ...
              <div className="mt-5 flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={onClose}
                    className="px-4 py-2 rounded-2xl bg-white/70 border border-white/30 text-gray-800 font-semibold hover:brightness-105 transition cursor-pointer"
                  >
                    إغلاق
                  </button>
                </div>
