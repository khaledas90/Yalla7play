...
import { Download, Star, Eye, Calendar, ShieldCheck, ChevronLeft, LayoutGrid, Gamepad2, Share2, Info } from "lucide-react";
          ...
          <div className="space-y-12">
            ...
            <div className="relative overflow-hidden rounded-[3rem] border border-blue-50 bg-white p-8 shadow-xl shadow-blue-900/5">
                ...
                <div className="mt-12 flex flex-col gap-4 sm:flex-row">
                    <button className="flex flex-1 items-center justify-center gap-3 rounded-[2rem] bg-blue-600 py-5 text-xl font-black text-white shadow-xl shadow-blue-500/30 transition hover:bg-blue-700 hover:scale-[1.02] active:scale-95">
            ...
            <div className="space-y-8 rounded-[3rem] border border-blue-50 bg-white p-8 md:p-12 shadow-sm">
                ...
                <div className="prose prose-slate max-w-none prose-p:text-lg prose-p:font-bold prose-p:leading-relaxed prose-p:text-slate-600">
                    ...
                    <p className="mt-6">تُعد هذه ال{type === "games" ? "لعبة" : "تطبيق"} واحدة من أكثر أنواع المحتوى الرقمي انتشارًا، حيث أصبحت تشكّل جزءًا أساسيًا من حياة الكثير من المستخدمين يوميًا. نحن نعمل على توفير دليل شامل مع مراجعات مستمرة وتحديثات دورية، لتكون دائمًا على اطلاع بأحدث الإصدارات وأكثرها تميزًا.</p>
                </div>
          ...
          <aside className="space-y-8 sticky top-32 h-fit hidden lg:block">
            <div className="rounded-[2.5rem] border border-blue-100 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-4">
                   {[
                     { label: "الحجم", value: "يختلف حسب الجهاز" },
                     { label: "الإصدار", value: "آخر تحديث" },
                     { label: "الشركة", value: "مطور رسمي" },
