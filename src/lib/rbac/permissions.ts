...
export const ADMIN_PAGES: PagePermission[] = [
  ...
  { path: "/admin/content/games", label: "الألعاب", category: "المحتوى" },
  { path: "/admin/content/apps", label: "التطبيقات", category: "المحتوى" },
  { path: "/admin/content/ads", label: "الإعلانات", category: "المحتوى" },
