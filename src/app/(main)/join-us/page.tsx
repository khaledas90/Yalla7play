...
import { CheckCircle2, DollarSign, Calendar, Zap, MessageSquare, Globe, Users } from "lucide-react";
  ...
  return (
    <main className="min-h-screen pt-32 pb-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-blue-700 to-indigo-900 p-8 text-white shadow-2xl md:p-16">
          <div className="relative z-10 text-center max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-blue-100 font-bold">تم فتح باب التسجيل في منصة يلا7 بلاي (منصة الملوك)!</p>
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
           {features.map((f, i) => (
             <div key={i} className="group relative overflow-hidden rounded-[2.5rem] border border-blue-50 bg-white p-8 transition hover:shadow-xl">
        ...
        <div className="mt-20 grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-8">
                <div className="space-y-6">
                    ...
                    <ul className="space-y-4">
                        {[
                            ...
                            <li key={i} className="flex items-start gap-3 rounded-2xl bg-slate-50 p-4 transition hover:bg-white hover:shadow-md border border-transparent hover:border-blue-100">
                ...
                <p className="text-lg font-bold text-slate-600 bg-blue-50 p-6 rounded-[2rem] border border-blue-100">
                لو الشروط دي بتنطبق عليك، فإنت الشخص المثالي لفرصتنا! هنساعدك تطور المحتوى بتاعك وتكسب دخل ثابت ومتصاعد.
                </p>
            </div>

            <div className="space-y-6 p-8 rounded-[3rem] border border-slate-100 bg-white shadow-xl shadow-blue-900/5">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 rounded-2xl border border-blue-50 p-4">
                ...
                <div className="pt-6 border-t border-slate-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {["فودافون كاش", "أورانج كاش", "اتصالات كاش", "إنستا باي", "تحويل بنكي", "PayPal", "Binance"].map((method, i) => (
                            <span key={i} className="rounded-xl bg-blue-50 px-3 py-1.5 text-sm font-bold text-blue-600 border border-blue-100">{method}</span>
                        ))}
                    </div>
        ...
        <div className="mt-20 text-center">
             <button className="rounded-[2rem] bg-indigo-600 px-12 py-5 text-xl font-black text-white shadow-2xl shadow-indigo-600/30 transition hover:bg-indigo-700 hover:scale-105 active:scale-95">
